...
void ExceptionClass::PrintCharMsg() const {

	cout << "Input data is not character type" << endl << "Retype : " << endl;

}

void ExceptionClass::PrintIntMsg() const {

	cout << "Input data is not integer type" << endl << "Retype : " << endl;
